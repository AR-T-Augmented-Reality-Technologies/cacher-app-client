            ...
            <div className="col-start-2 col-span-6">
                ...
                <form className="">
                    <div className="flex flex-col justify-center items-center">
                        {showApp ? (<><label className="flex justify-center items-center text-gray-500 font-bold mb-2" onClick={displayApp}>App Settings ▸</label>
                        </>) : <> <label className="text-gray-500 font-bold mb-2 pb-10" onClick={displayApp}>App Settings ▼</label>
                        </>}
                        {showApp && (
                            <div className="pb-10">
                    ...
                    <div className="flex flex-col justify-center items-center">
                        {showPrivate ? (<><label className="block text-gray-500 font-bold mb-2" onClick={displayPrivate}>Privacy Settings ▸ </label>
                        </>) : <> <label className="block text-gray-500 font-bold mb-2 pb-10" onClick={displayPrivate}>Privacy Settings ▼ </label>
                        </>}
                        {showPrivate && (
                            <div className="flex flex-col justify-center items-center">
                                <div className="pb-10">
                                <button className="bg-custom-blue hover:bg-custom-blue-hover dark:bg-dblue hover:dark:bg-dorange text-white font-bold py-2 px-4 rounded 
                            focus:outline-none focus:shadow-outline" type="button"> Privatise Profile</button>
                                </div>
