    ...
    return <>
        <div className="grid grid-cols-8 min-h-screen">
            ...
            <div className="col-start-2 col-span-6">
                <img src="images/cacher-logo.png" alt="Logo" className="lg:w-1/5 sm:w-2/5 md:w-2/5 mx-auto mt-5"></img>
                <form className="w-full max-w-sm sm:w-full mt-6 mx-auto">
                    <div className="mb-6">
                        <label className="block text-gray-500 font-bold mb-2" htmlFor="inline-email">Email</label>
                    ...
                    <div className="mb-6">
                        <label className="block text-gray-500 font-bold mb-2" htmlFor="inline-password">Password</label>
                        <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4
            ...
            All 3 lines will be displayed on desktop. On mobile devices only 2 lines will be displayed to save spac*/}
