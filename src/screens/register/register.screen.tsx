            ...
            <div className="col-start-2 col-span-6">
                ...
                <form className="w-full max-w-sm sm:w-full mt-4 mx-auto">
                    ...
                    <div className="mb-4">
                        ...
                        <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4
                         text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-custom-blue" id="username-input" type="text"/>
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4
                         text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-custom-blue" id="confirmPassword-input" type="password"/>
                    </div>
                    <div className="flex items-center justify-between">
                    <div className="mb-4">
                        <label className="block text-gray-500 font-bold mb-2" htmlFor="fnameLabel">First Name</label>
                        <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4
                         text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-custom-blue" id="fname-input" type="text"/>
                    </div>
                    <div className="ml-6 mb-4">
                        <label className="block text-gray-500 font-bold mb-2" htmlFor="lnameLabel">Last Name</label>
                        <input className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4
                         text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-custom-blue" id="lname-input" type="text"/>
                    </div>
                    </div>
                    <div className="mb-6">
                        ...
                        <input className="bg-gray-200 appearance-none border-2 h-10 border-gray-200 rounded w-full py-2 px-4
                         text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-custom-blue" id="dob-input" type="date"/>
                    </div>
